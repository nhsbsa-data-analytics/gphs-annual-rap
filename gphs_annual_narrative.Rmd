...
Fees are also payable to dispensing contractors for dispensing and for providing essential and advanced services to NHS patients. Many, but not all, fees are described in these summary statistics alongside their accompanying [summary tables](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx). Details of what fees are payable to community pharmacies and appliance contractors can be found in the [Drug Tariff for England and Wales](https://www.nhsbsa.nhs.uk/pharmacies-gp-practices-and-appliance-contractors/drug-tariff). Fee payments to dispensing contractors for prescribing and other services are known as remuneration.
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 1](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 3 and 10](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)
...
Source: [Summary Tables - General Pharmaceutical Services - Table 8](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 6](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)

In 2021/22 the number of AURs increased by 61.9% from 2020/21, which had seen a decrease after 5 years of steady increases. During 2020/21 regional and national restrictions were introduced to tackle the COVID-19 pandemic. This included restrictions on face-to-face services between patients and pharmacies. Telephone and video options were introduced for AURs during the COVID-19 pandemic, although these were not available for the full year. The number of AURs is 92.2% higher than 2015/16.
...
1 November 2020, general practices have been able to refer patients for a minor illness consultation via CPCS, once a local referral pathway has been agreed.
...
<!-- )   -->
<!-- ``` -->
<!-- Source: [Summary Tables - General Pharmaceutical Services - Table 2](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx) -->
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 7](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)
...
national_month_extract %>%
  ...
  hc_xAxis(type = "datetime")
```
Source: [Summary Tables - General Pharmaceutical Services - Table 9](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2022-summary-tables-v001.xlsx)

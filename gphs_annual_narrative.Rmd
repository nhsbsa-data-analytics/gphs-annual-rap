---
title: "General Pharmaceutical Services <br>England 2015/16 to 2021/22"
...
* 4.85 million seasonal influenza vaccines were administered by community pharmacies in 2021/22. This was a 75.1% increase from the 2.77 million vaccines administered in  2020/21.
...
Fees are also payable to dispensing contractors for dispensing and for providing essential and advanced services to NHS patients. Many, but not all, fees are described in these summary statistics alongside their accompanying [summary tables](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx). Details of what fees are payable to community pharmacies and appliance contractors can be found in the [Drug Tariff for England and Wales](https://www.nhsbsa.nhs.uk/pharmacies-gp-practices-and-appliance-contractors/drug-tariff). Fee payments to dispensing contractors for prescribing and other services are known as remuneration.

Further definitions of terms used in this publication can be found in the Glossary of the [Background Information and Methodology](https://www.nhsbsa.nhs.uk/statistical-collections/general-pharmaceutical-services-england/general-pharmaceutical-services-england-201516-202122) supporting document that accompanies this release.
...
### Essential Services for Contractors {.toc-ignore}
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 1](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 3 and 10](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)

The number of items dispensed by community pharmacies in England between 2020/21 and 2021/22 increased by 2.59% from 1.02 billion to 1.04 billion. Overall, the number of items dispensed is 4.80% higher than the 995 million items dispensed in 2015/16.

The number of items dispensed by appliance contractors in 2021/22 increased by 8.86% from 2020/21. This has increased each year since 2015/16, from 7.91 million to 10.9 million items. This is an increase of 37.9%.
...
The average number of items dispensed per contractor has increased by 3.60% from 87,400 in 2020/21 to 90,500 in 2021/22.  This is an increase of 8.68% from the average of 83,300 in 2015/16.
...
#### **`r paste0("Figure ",4,": Number of items dispensed via the Electronic Prescription Service (EPS) between 2015/16 and 2021/22")`**
...
An NHS prescription can be fulfilled by either a paper form presented to a contractor by a patient, or by the Electronic Prescription Service (EPS). Since 2015/16 the proportion of prescription items that have been dispensed via EPS by community pharmacies and appliance contractors has increased significantly, and EPS is now the primary method that prescriptions are issued and dispensed by.
...
The value of SAFs received by contractors increased in 2021/22 by 3.90% to £1.37 billion from £1.31 billion in 2020/21, which was a return to trend following a decrease in 2020/21 but following five years of increases between 2015/16 and 2019/20. The value has increased from £920 million in 2015/16 to £1.31 billion in 2021/22, an increase of 48.4%. This has been driven by increases in the amount received for each SAF, from 90p in April 2015 to 129p in August 2021. It should be noted, prior to December 2016 the figures reported are for professional fees only, and do not include the three additional payments that the SAF consists of.

<!-- Another essential service contractors provide is the Discharge Medicine Service (DMS). This was introduced in February 2021 and allows patients discharged from NHS Trust hospitals who need extra support with their medicines to be referred to their community pharmacy. -->
...
<!-- ``` -->
### Advanced Services for Contractors {.toc-ignore} 
...
The figures in these statistics for flu vaccinations only relate to those administered by community pharmacies, and do not include vaccines issued to GP patients, healthcare workers, or children of primary school age. [Official Statistics for these are produced by UK Health Security Agency (UKHSA)](https://www.gov.uk/health-and-social-care/health-protection-immunisation).
...
Source: [Summary Tables - General Pharmaceutical Services - Table 8](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)

The number of vaccines administered by pharmacies as part of the Flu Vaccination Advanced Service has increased by 8.15 times since the service began in 2015/16. In 2021/22 there were  4.85 million vaccines administered by 9,860 community pharmacies at an average of 492 vaccines per pharmacy. This was an increase of 75.1% on the 2.77 million vaccines administered in 2020/21.
...
The number of NMSs claimed in 2021/22 increased by 125% from 933,000 in 2020/21 to 2.10 million in 2021/22, a return to trend after a decrease in 2020/21 following five years of increases. The number of NMSs is  155% higher than the 822,000 claimed in 2015/16. 

During 2021/222 a catch-up NMS was introduced for patients who were prescribed a new medicine but did not receive an NMS or any additional support during the COVID-19 pandemic.This catch-up service was offered to eligible patients between 1st September 2021 and 31st March 2022.
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 6](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)

In 2021/22 the number of AURs increased by 61.9% from 2020/21, which had seen a decrease after 5 years of steady increases. During 2020/21 regional and national restrictions were introduced to tackle the COVID-19 pandemic. This included restrictions on face-to-face services between patients and pharmacies. Telephone and video options were introduced for AURs during the COVID-19 pandemic, although these were not available for the full year. The number of AURs carried out in 2020/21 increased by 92.2% compared to 2015/16.

This advanced service can be offered by both community pharmacies and appliance contractors and a breakdown by contractor type and AUR type can be found in Table 6 in the accompanying summary tables.
...
The total cost of fees for Appliance Use Reviews increased by 30.9% in 2021/22 to £2.73 million from the £2.09 million paid in 2021/22. In line with the increase in the number of reviews undertaken,  the total paid was 47.9% higher than the £1.85 million paid in 2015/16.
...
The fee for Stoma Appliance Customisation is a set payment that has not changed since its introduction so the increase in the cost of the fees mirrors the increasing trend for the number of SACs carried out. In total, £6.96 million  was spent in 2021/22 compared to £6.63 million in 2015/16. In line with the increase in the number of SACs provided each year, the fees paid to community pharmacies as part of the advanced service have increased. As the SAC is a set payment that has not changed since its introduction this percentage increase for 2021/22 is also 4.98%.
...
The fee for providing the Community Pharmacist Consultation Service is £14 (including VAT) per consultation.
...
<!-- )   -->
<!-- ``` -->
<!-- Source: [Summary Tables - General Pharmaceutical Services - Table 2](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx) -->
...
```
Source: [Summary Tables - General Pharmaceutical Services - Table 7](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)

The cost of fees paid for Community Pharmacy Consultation Services in 2021/22 was £12.6 million, a 81.4% increase on the £5.31 million  claimed in 2020/21.
...
national_extract %>%
  ...
  plotLines = list(
    list(
      ...
      label = list(
        rotation = 0,
        text = "<b>Note:</b> The figures <br>at this point <br> do not represent<br> the full financial year<br> and are for <br>November 2020 to <br>March 2021 only",
        style = list(
          fontSize = "10px"
        )
      )
...
The cost of drugs paid for Community Pharmacy Consultation Services in 2021/22 was £2.84 million, an 81.4% increase on the £1.56 million  claimed in 2020/21.
...
<!-- The cost of Hypertension Case-Finding Advanced Service Incentive payments in 2021/22 was £713,000 -->
...
#### **`r paste0("Figure ",17,": Total Community Pharmacy Home Delivery Services 2021/22")`**
...
national_month_extract %>%
  ...
  hc_xAxis(type = "datetime")
```
Source: [Summary Tables - General Pharmaceutical Services - Table 9](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/gphs/gps-2122-summary-tables-v001.xlsx)
...
#### **`r paste0("Figure ",18,": Total Cost of Community Pharmacy Home Delivery Services 2021/22")`**
...
The cost of fees paid for the Home Delivery Services had the same variation as the number of home deliveries with a total of £2.74 million paid for Home Delivery Services. April 2021 was the highest value month with £808,000 in fees paid.

#### Community Pharmacy Covid-19 Lateral Flow Device Distribution Service

Community Pharmacy Covid-19 Lateral Flow Device Distribution Service is an Advanced Service in the NHS Community Pharmacy Contractual Framework (CPCF). The service was introduced in March 2021 and ended on 31 March 2022.
...
Pharmacies who registered for the service received a one-off set-up fee of £250 plus VAT. An early sign-up fee of £200 plus VAT was also available for pharmacies who signed up to provide the service by 18 April 2021.

From 29 March 2021, a service fee of £1.50 plus VAT per transaction applied. 

From 4 October 2021 there were two service fees: 

* A service fee of £1.70 plus VAT per transaction using a collect code
* A service fee of £1.20 plus VAT per transaction not using a collect code.

#### **`r paste0("Figure ",19,": Total Cost of Community Pharmacy Covid-19 Lateral Flow Device Distribution Services fees 2021/22")`**
```{r cvd_test_kit}
national_month_extract %>%
  filter(APPLIANCE_DISPENSER_HIST == "N") %>% 
...
The cost of Community Pharmacy Covid-19 Lateral Flow Device Distribution Services fees in 2021/22 was £66.0 million.

This does not include any cost for the Lateral Flow Devices which were supplied free of charge to pharmacies providing the service as part of their standard deliveries from wholesalers. Data on the cost of devices is not held by the NHSBSA. 
...
### Enhanced Services for Contractors {.toc-ignore} 

As well as national services provided by all pharmacies, the  NHS Community Pharmacy Contractual Framework (CPCF) also includes services that are commissioned at a local level, known as Local Enhanced Services (LES). 

In December 2021, provisions were made within the NHS (Pharmaceutical and Local Pharmaceutical Services) Regulations 2013 for a new type of Enhanced service, the National Enhanced Service. Under this type of service, NHS England And Improvement (NHSE&I) commissions an Enhanced service that is nationally specified. 
...
The figures in these statistics for COVID-19 vaccinations only relate to those administered by community pharmacies. [Official Statistics for all COVID-19 vaccinations are produced by UK Health Security Agency](https://coronavirus.data.gov.uk/).
...
The costs of COVID-19 vaccines fees in 2021/22 were £334 million, with a peak starting in autumn when Phase 3 launched.
...
The designation of this publication as a National Statistic was confirmed in December 2021 following an [assessment](https://osr.statisticsauthority.gov.uk/correspondence/ed-humpherson-to-matthew-wilson-confirmation-of-national-statistics-designation-for-statistics-on-general-pharmaceutical-services-in-england/)
 by the Office for Statistics Regulation (OSR).
...
Details of the Medicines Use Reviews (MUR) service have been removed. This service was decommissioned on 31 March 2021. Historical data is included in the summary tables. 

Some data regarding COVID-19 related services that  were undertaken by pharmacies are included in this release.
...
Data regarding the essential service Discharge Medicine Service and the advanced services of Hypertension Case-Finding and Hepatitis C testing have also been added to the summary tables.

Data relating to covid-19 related services have also been added to the supporting summary tables:
...
Following user feedback changes to the tables have been made to make them easier to use.

Tables 1 and 2 have been split into further tables to make them more user-friendly, grouping together similar data. 

The supporting summary tables have been pivoted into a 'long' format to increase machine readability in line with recognised best practice to make spread sheets more [accessible.](https://analysisfunction.civilservice.gov.uk/policy-store/data-visualisation-tables/) 

Previously some figures in the supplementary tables regarding fees and fee counts had been rounded to the nearest 10, to reflect that these figures are estimated based on claims by contractors and that work will be done to confirm these payments. This rounding has been discontinued as the figures, while based on claims are based on the values paid to contractors. Users should always use the statistics in the latest release of the publication to make sure they are the most up to date figures available.
...
The publication date by NHS Digital has historically been in November, as continued by the first in series of this publication by the NHSBSA. The publication was brought forward to October and the NHSBSA will be looking to bring this forward again for the 2022/23 release.
...
The NHS England Regions and Integrated care boards (ICBs)  shown in the statistical summary tables of this release are based on the new NHS organisational structure as of July 2022.

### 3.7 Planned changes to this publication {.toc-ignore}
...
NHSBSA plans to expand the scope of this publication in future releases to report on all fees that a contractor can claim for providing NHS services, in order to provide a more complete picture of the total cost of community pharmacy to the public purse. Next year's release will include the advanced services of Smoking Cessation Service (SCS) which commenced in late March 2022<sup>2</sup> and Pharmacy Contraception Service due to commence in January 2023.

<small>2. Although this service commenced in 2021/2022, no data is held for the 2021/22 publication due to the timing of the service start.</small> 
